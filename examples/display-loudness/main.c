...
#define SAMPLING_DISPLAY_COUNT 1
#define SAMPLING_LOUDNESS_COUNT 3

uint32_t timer_count = 0;

void timer_fired(__attribute__ ((unused)) int a1,
                 ...
                 __attribute__ ((unused)) void* a4)
{
    ...
    if (timer_count % SAMPLING_LOUDNESS_COUNT == 0)
    {
    ...
    if (timer_count % SAMPLING_DISPLAY_COUNT == 0)
    {
        printf("d");
    }
